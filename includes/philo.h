...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/21 20:18:05 by mcentell          #+#    #+#             */
/*   Updated: 2025/01/21 20:20:52 by mcentell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				destroy_all(char *message, t_simulation *simulation,
...
void				initialize_philosopher_input(t_philosopher *philosopher,
						char **argv);
void				initialize_philosopher_state(t_philosopher *philosopher,
						int id);
void				initialize_philosopher_times(t_philosopher *philosopher,
						char **argv);
...
int					create_threads(t_simulation *simulation,
						pthread_mutex_t *forks);
void				create_and_join_threads(t_philosopher *philosophers,
						char **argv);
...
void				print_status_message(char *message,
						t_philosopher *philosopher, int id);
